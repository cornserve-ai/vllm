...
class CornserveConfig:
    ...
    scheduler_policy: str = "CORNSERVE"
    """The scheduler policy for Cornserve. Optionas: [FCFS, CORNSERVE]"""
    verify_encoder: bool = False
    """Whether to verify the received encoder output."""
...
class VllmConfig:
    ...
    """The sidecar ranks for CornServe."""
    instance_id: str = ""
