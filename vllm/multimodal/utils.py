...
from .inputs import PlaceholderRange, DataForward
...
class MediaConnector:
    ...
    async def fetch_audio_async(
        self,
        audio_url: str,
    ) -> tuple[np.ndarray, Union[int, float]] | DataForward[tuple[np.ndarray, Union[int, float]]]:
        """
    ...
    async def fetch_image_async(
        ...
        *,
        image_mode: str = "RGB",
    ) -> Image.Image | DataForward[Image.Image]:
        """
    ...
    async def fetch_video_async(
        ...
        *,
        image_mode: str = "RGB",
        num_frames: int = 32,
    ) -> npt.NDArray | DataForward[npt.NDArray]:
        """
